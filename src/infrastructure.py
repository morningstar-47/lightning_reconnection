...
Définit la classe Infrastructure et utilise les constantes importées
depuis `config.py` (prix, durée, coûts des ouvriers, etc.).
"""
...
class Infrastructure:
    def __init__(self, infra_id, type_infra, infra_type, longueur, nb_maisons):
        ...
        # si on met n ouvriers simultanément, le temps écoulé = self.duree / n
        # Le coût des ouvriers (salaire) total est indépendant du n
